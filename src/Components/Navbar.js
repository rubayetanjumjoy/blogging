  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form className="d-flex">
        <input className="form-control me-2 searchinput" type="search"  onChange={handleSearch} placeholder="Search" aria-label="Search" />
        <svg style={{color:'white'}} xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-search mt-1" viewBox="0 0 16 16" >
