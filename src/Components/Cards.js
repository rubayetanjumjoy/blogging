...
const Cards = (height,width) => {
  ...
  <h4 className='blogHover'> <Link to="/details" style={{ color: 'inherit', textDecoration: 'inherit'}}> Review of the Gibbs Report</Link></h4>
  <p class="card-text blogHover " >
    <Link to="/details" style={{ color: 'inherit', textDecoration: 'inherit'}}>
